...
export default function GetStartedPage() {
    ...
    const handleSubmit = async () => {
        ...
        switch (fileExtension) {
            case "aasx":
                endpoint = `/companies/${companyId}/products/import/aasx/`;
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center space-x-4">
                            ...
                            <Link href="/self-assessment">
                                <button
                                    className="px-4 py-2 border-2 border-gray-300 rounded-md font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800">
                                    Manual Entry
                                </button>
                            </Link>
                        </div>
