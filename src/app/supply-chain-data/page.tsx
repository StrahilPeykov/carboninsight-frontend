...
//                         <p>
//                           <span className="font-medium">Component:</span> {supplier.component}
//                         </p>
//                         <p>
...
//                             {supplier.carbon_footprint_unit || "kg CO₂e"}
//                           </p>
//                         )}
//                       </div>
//                     </div>
...
//                             className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600"
//                           >
//                             <option value="dpp_aasx">
//                               Digital Product Passport (DPP in AASX format)
//                             </option>
