...
export default function ResultsPage() {
  ...
  return (
    <div className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {error && (
        <div className="max-w-3xl mx-auto mb-6 p-4 bg-red-100 text-red-800 rounded-md">
          {error}
        </div>
      )}
      ...
      {result ? (
          ...
          <Card className="md:col-span-2">
            ...
            <div className="flex flex-wrap justify-center space-x-4">
              {result.dpp_generated ? (
                <Button onClick={handleDownloadDPP}>
                  Download Digital Product Passport
                </Button>
              ) : (
            ...
            <div className="space-y-4">
              {result.recommendations && result.recommendations.length > 0 ? (
                result.recommendations.map((rec) => (
                  <div key={rec.id} className="p-3 bg-green-50 border border-green-200 rounded-md dark:bg-green-900/20 dark:border-green-900">
        ...
        <div className="text-center">
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
            No results available. Please complete the assessment process to see your carbon footprint results.
          </p>
