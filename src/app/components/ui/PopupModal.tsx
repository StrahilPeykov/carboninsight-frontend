            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-md p-6">
                <header className="flex justify-between items-center mb-4">
                    ...
                    <Button
                        ...
                        className="text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-white bg-transparent hover:bg-gray-200 dark:hover:bg-gray-700 rounded-full w-8 h-8 flex items-center justify-center"
                    >
                        &times;
                    </Button>
                </header>

                <div className="mb-4 text-gray-700 dark:text-gray-300 [&_*]:text-inherit">{children}</div>
