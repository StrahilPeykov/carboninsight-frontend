  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        // In a real app, we would also fetch product count and recent activity
        // For now, let's use placeholder data
        setProductCount(0);
        setRecentActivity([
          { date: "2025-05-12", action: "Created new company: Acme Corp" },
          { date: "2025-05-11", action: "Generated DPP for Product X" },
          { date: "2025-05-10", action: "Added supplier data for Component Y" }
        ]);
    ...
    <div className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-lg text-gray-500 dark:text-gray-400">
          Manage your companies, products, and carbon footprint data
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        ...
        <Card>
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">
            Start the step-by-step process to calculate your product carbon footprint and generate a Digital Product Passport.
          </p>
          <div className="space-y-3">
